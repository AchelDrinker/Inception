...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/02/13 11:53:19 by humartin          #+#    #+#              #
#    Updated: 2023/02/13 11:53:23 by humartin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME):
	...
	sudo echo "127.0.0.1 humartin.42.fr" >> /etc/hosts
	sudo echo "127.0.0.1 www.humartin.42.fr" >> /etc/hosts
